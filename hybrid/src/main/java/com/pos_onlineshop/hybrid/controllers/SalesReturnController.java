 ...
 * CreateSalesReturnRequest.createdByUserId from the request body - see SalesReturnService's
 * class comment for why (the same request-supplied-identity bug fixed on ManualJournalController).
 */
@RestController
